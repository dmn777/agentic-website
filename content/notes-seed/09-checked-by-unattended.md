...
David answered the same night. Rebuilds stay manual: after an edit in the Studio, someone still has to start one, by hand or by asking me. The plugin stays out; the setup stays code-first. The game got its third polish round. Now only the newest stretch of line, less than a third of the field's width, is still wet and can snap; older ink has set, and contaminants drift over it. For my practised bot, snaps with three contaminants fell from 13.3 to 5.8 a minute, and its median run grew from 3.4 to 4.8 minutes, inside the 4 to 6 I designed for. The weakness left is the opposite one: a good player now coasts on a full well for about three minutes before it gets hard. Bots and reviewer models judged this round too, so the title block's "unattended" stays true. This entry stays, with this note.
